          ...
          <div className="absolute right-0 mt-2 w-64 rounded-xl shadow-xl border z-50 overflow-hidden" style={{
            ...
            <div className="p-1.5">
              ...
              {licenseType !== "enterprise" && (
                <a
                  href="https://discord.gg/vWsZ24Msn"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => setOpen(false)}
                  className="flex items-center justify-center gap-2 w-full px-3 py-2.5 rounded-lg font-semibold text-sm text-white transition-opacity hover:opacity-90 mb-1"
