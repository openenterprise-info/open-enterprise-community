      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-52 bg-white border-r border-gray-200 flex flex-col shrink-0">
          ...
          <div className="shrink-0 border-t border-gray-100 px-3 py-3">
            ...
            {licenseType !== "enterprise" && (
              <a href="https://discord.gg/vWsZ24Msn" target="_blank" rel="noopener noreferrer"
                className="mt-2 w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold text-white transition-opacity hover:opacity-90"
